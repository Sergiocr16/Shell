...
public class MedidaResource {
    ...
    @PostMapping("/medidas")
    @Timed
    public ResponseEntity<MedidaDTO> createMedida(@RequestBody MedidaDTO medidaDTO) throws URISyntaxException {
    ...
    @PutMapping("/medidas")
    @Timed
    public ResponseEntity<MedidaDTO> updateMedida(@RequestBody MedidaDTO medidaDTO) throws URISyntaxException {
